...
const MODEL_REGISTRY: Record<string, ModelCapabilities> = {
  ...
  "llama3.2": { provider: "ollama", toolCalling: true, jsonMode: true, streaming: true, contextWindow: 128000, inputCostPer1M: 0, outputCostPer1M: 0 },
  "llama3.1": { provider: "ollama", toolCalling: true, jsonMode: true, streaming: true, contextWindow: 128000, inputCostPer1M: 0, outputCostPer1M: 0 },
